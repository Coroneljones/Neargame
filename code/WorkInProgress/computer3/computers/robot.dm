...
/datum/file/program/borg_control
		...
		if (src.temp)
				...
				for(var/mob/living/silicon/robot/R in mob_list)
					...
					if (istype(usr, /mob/living/silicon))
						if(issilicon(usr) && is_special_character(usr) && !R.emagged)
							dat += "<A href='byond://?src=\ref[src];magbot=\ref[R]'>(<i>Hack</i>)</A> "
					dat += "<A href='byond://?src=\ref[src];stopbot=\ref[R]'>(<i>[R.canmove ? "Lockdown" : "Release"]</i>)</A> "
					dat += "<A href='byond://?src=\ref[src];killbot=\ref[R]'>(<i>Destroy</i>)</A>"
					dat += "<BR>"
			...
			if(screen == 2)
				if(!src.status)
					...
					\n<BR>
					\n<A href='byond://?src=\ref[src];killall'>Start Sequence</A><BR>
					\n<BR>
					\n<A href='byond://?src=\ref[usr];close'>Close</A>"}
				else
					...
					\n<BR>
					\n<A href='byond://?src=\ref[usr];mach_close=computer'>Close</A>"}
				dat += "<A href='byond://?src=\ref[src];screen=0'>(Return to Main Menu)</A><BR>"
	...
	Topic(var/href, var/list/href_list)
		...
		if ("killall" in href_list)
			...
			<BR><B><A href='byond://?src=\ref[src];do_killall'>\[Swipe ID to initiate destruction sequence\]</A></B><BR>

...
/datum/file/program/holodeck
	...
	interact()
		...
		dat += "<A href='byond://?src=\ref[src];emptycourt'>((Empty Court)</font>)</A><BR>"
		dat += "<A href='byond://?src=\ref[src];boxingcourt'>((Boxing Court)</font>)</A><BR>"
		dat += "<A href='byond://?src=\ref[src];basketball'>((Basketball Court)</font>)</A><BR>"
		dat += "<A href='byond://?src=\ref[src];thunderdomecourt'>((Thunderdome Court)</font>)</A><BR>"
		dat += "<A href='byond://?src=\ref[src];beach'>((Beach)</font>)</A><BR>"
//		dat += "<A href='byond://?src=\ref[src];turnoff'>((Shutdown System)</font>)</A><BR>"
		...
		if(emagged)
			dat += "<A href='byond://?src=\ref[src];burntest'>(<font color=red>Begin Atmospheric Burn Simulation</font>)</A><BR>"
			dat += "Ensure the holodeck is empty before testing.<BR>"
			dat += "<BR>"
			dat += "<A href='byond://?src=\ref[src];wildlifecarp'>(<font color=red>Begin Wildlife Simulation</font>)</A><BR>"
			dat += "Ensure the holodeck is empty before testing.<BR>"
			dat += "<BR>"
			if(issilicon(usr))
				dat += "<A href='byond://?src=\ref[src];AIoverride'>(<font color=green>Re-Enable Safety Protocols?</font>)</A><BR>"
			dat += "Safety Protocols are <font class='bad'>DISABLED</font><BR>"
		else
			if(issilicon(usr))
				dat += "<A href='byond://?src=\ref[src];AIoverride'>(<font color=red>Override Safety Protocols?</font>)</A><BR>"
			dat += "<BR>"

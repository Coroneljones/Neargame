...
/obj/machinery/computer/scan_consolenew/Topic(href, href_list)
	...
	switch(current_screen)
		if ("mainmenu")
			...
			if (viable_occupant) //is there REALLY someone in there who can be modified?
				temp_html += text("<A href='byond://?src=\ref[];screen=unimenu'>Modify Unique Identifier</A><br />", src)
				temp_html += text("<A href='byond://?src=\ref[];screen=strucmenu'>Modify Structural Enzymes</A><br /><br />", src)
			else
			...
			temp_html += text("<A href='byond://?src=\ref[];screen=radsetmenu'>Radiation Emitter Settings</A><br /><br />", src)
			temp_html += text("<A href='byond://?src=\ref[];screen=buffermenu'>Transfer Buffer</A><br /><br />", src)
		...
		if ("unimenu")
			if(!viable_occupant)
				...
				temp_html = "<A href='byond://?src=\ref[src];screen=mainmenu'><< Main Menu</A><br />"
				...
				temp_html += "Selected Block: <A href='byond://?src=\ref[src];unimenuminus=1'><-</A> <B>[ui_block]</B> <A href='byond://?src=\ref[src];unimenuplus=1'>-></A><br /><br />"
				temp_html += "Selected Sub-Block: <A href='byond://?src=\ref[src];unimenusubminus=1'><-</A> <B>[subblock]</B> <A href='byond://?src=\ref[src];unimenusubplus=1'>-></A><br /><br />"
				temp_html += "Selected Target: <A href='byond://?src=\ref[src];unimenutargetminus=1'><-</A> <B>[unitargethex]</B> <A href='byond://?src=\ref[src];unimenutargetplus=1'>-></A><br /><br />"
				temp_html += "<B>Modify Block</B><br />"
				temp_html += "<A href='byond://?src=\ref[src];unipulse=1'>Irradiate</A></div>"
		...
		if ("strucmenu")
			if(!viable_occupant)
				...
				temp_html += "Selected Block: <A href='byond://?src=\ref[src];strucmenuminus=1'><-</A> <B>[se_block]</B> <A href='byond://?src=\ref[src];strucmenuplus=1'>-></A><br /><br />"
				temp_html += "Selected Sub-Block: <A href='byond://?src=\ref[src];strucmenusubminus=1'><-</A> <B>[subblock]</B> <A href='byond://?src=\ref[src];strucmenusubplus=1'>-></A><br /><br />"
				temp_html += "<B>Modify Block</B><br />"
				temp_html += "<A href='byond://?src=\ref[src];strucpulse=1'>Irradiate</A></div>"

		if ("radsetmenu")
			temp_html = "<A href='byond://?src=\ref[src];screen=mainmenu'><< Main Menu</A><br />"
			temp_html += "<h3>Radiation Emitter Settings</h3>"
			if (viable_occupant)
				temp_html += text("<A href='byond://?src=\ref[];genpulse=1'>Pulse Radiation</A>", src)
			else
				temp_html += "<span class='linkOff'>Pulse Radiation</span>"
			temp_html += "<br /><br />Radiation Duration: <A href='byond://?src=\ref[src];radleminus=1'>-</A> <font color='green'><B>[radduration]</B></FONT> <A href='byond://?src=\ref[src];radleplus=1'>+</A><br />"
			temp_html += "Radiation Intensity: <A href='byond://?src=\ref[src];radinminus=1'>-</A> <font color='green'><B>[radstrength]</B></FONT> <A href='byond://?src=\ref[src];radinplus=1'>+</A><br /><br />"
		...
		if ("buffermenu")
			...
			if (viable_occupant) temp_html += text("Save : <A href='byond://?src=\ref[];b1addui=1'>UI</A> - <A href='byond://?src=\ref[];b1adduiue=1'>UI+UE</A> - <A href='byond://?src=\ref[];b1addse=1'>SE</A><br />", src, src, src)
			if (buffer1) temp_html += text("Transfer to: <A href='byond://?src=\ref[];b1transfer=1'>Occupant</A> - <A href='byond://?src=\ref[];b1injector=1'>Injector</A><br />", src, src)
			//if (buffer1) temp_html += text("<A href='byond://?src=\ref[];b1iso=1'>Isolate Block</A><br />", src)
			if (buffer1) temp_html += "Disk: <A href='byond://?src=\ref[src];save_disk=1'>Save To</a> | <A href='byond://?src=\ref[src];load_disk=1'>Load From</a><br />"
			if (buffer1) temp_html += text("<A href='byond://?src=\ref[];b1label=1'>Edit Label</A><br />", src)
			if (buffer1) temp_html += text("<A href='byond://?src=\ref[];b1clear=1'>Clear Buffer</A><br /><br />", src)
			...
			if (viable_occupant) temp_html += text("Save : <A href='byond://?src=\ref[];b2addui=1'>UI</A> - <A href='byond://?src=\ref[];b2adduiue=1'>UI+UE</A> - <A href='byond://?src=\ref[];b2addse=1'>SE</A><br />", src, src, src)
			if (buffer2) temp_html += text("Transfer to: <A href='byond://?src=\ref[];b2transfer=1'>Occupant</A> - <A href='byond://?src=\ref[];b2injector=1'>Injector</A><br />", src, src)
			//if (buffer2) temp_html += text("<A href='byond://?src=\ref[];b2iso=1'>Isolate Block</A><br />", src)
			if (buffer2) temp_html += "Disk: <A href='byond://?src=\ref[src];save_disk=2'>Save To</a> | <A href='byond://?src=\ref[src];load_disk=2'>Load From</a><br />"
			if (buffer2) temp_html += text("<A href='byond://?src=\ref[];b2label=1'>Edit Label</A><br />", src)
			if (buffer2) temp_html += text("<A href='byond://?src=\ref[];b2clear=1'>Clear Buffer</A><br /><br />", src)
			...
			if (viable_occupant) temp_html += text("Save : <A href='byond://?src=\ref[];b3addui=1'>UI</A> - <A href='byond://?src=\ref[];b3adduiue=1'>UI+UE</A> - <A href='byond://?src=\ref[];b3addse=1'>SE</A><br />", src, src, src)
			if (buffer3) temp_html += text("Transfer to: <A href='byond://?src=\ref[];b3transfer=1'>Occupant</A> - <A href='byond://?src=\ref[];b3injector=1'>Injector</A><br />", src, src)
			//if (buffer3) temp_html += text("<A href='byond://?src=\ref[];b3iso=1'>Isolate Block</A><br />", src)
			if (buffer3) temp_html += "Disk: <A href='byond://?src=\ref[src];save_disk=3'>Save To</a> | <A href='byond://?src=\ref[src];load_disk=3'>Load From</a><br />"
			if (buffer3) temp_html += text("<A href='byond://?src=\ref[];b3label=1'>Edit Label</A><br />", src)
			if (buffer3) temp_html += text("<A href='byond://?src=\ref[];b3clear=1'>Clear Buffer</A><br /><br />", src)
	...
	dat += "<A href='byond://?src=\ref[src];'>Scan</A> "

	if (occupant && occupant.dna)
		dat += "<A href='byond://?src=\ref[src];locked=1'>[scanner_access_text]</A> "
		if (human_occupant)
			dat += "<A href='byond://?src=\ref[src];rejuv=1'>Inject Rejuvenators</A><br />"
		else
	...
	if (!isnull(diskette))
		dat += text("<A href='byond://?src=\ref[];eject_disk=1'>Eject Disk</A><br />", src)

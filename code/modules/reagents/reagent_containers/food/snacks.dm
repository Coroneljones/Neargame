...
/obj/item/reagent_containers/food/snacks/monkeycube/Crossed(A as obj)
...
/obj/item/reagent_containers/food/snacks/meatbreadslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("protein", 4)
		reagents.add_reagent("nutriment", 2)
...
/obj/item/reagent_containers/food/snacks/xenomeatbreadslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("protein", 4)
		reagents.add_reagent("nutriment", 2)
...
/obj/item/reagent_containers/food/snacks/bananabreadslice/New()
	..()
	if(!(reagents.total_volume))
...
/obj/item/reagent_containers/food/snacks/tofubreadslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 6)
...
/obj/item/reagent_containers/food/snacks/carrotcakeslice/New()
	..()
	if(!(reagents.total_volume))
...
/obj/item/reagent_containers/food/snacks/braincakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("protein", 5)
		reagents.add_reagent("nutriment", 1)
...
/obj/item/reagent_containers/food/snacks/cheesecakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("protein", 3)
		reagents.add_reagent("nutriment", 2)
...
/obj/item/reagent_containers/food/snacks/plaincakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 4)
...
/obj/item/reagent_containers/food/snacks/orangecakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 4)
...
/obj/item/reagent_containers/food/snacks/limecakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 4)
...
/obj/item/reagent_containers/food/snacks/lemoncakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 4)
...
/obj/item/reagent_containers/food/snacks/chocolatecakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 4)
...
/obj/item/reagent_containers/food/snacks/birthdaycakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 4)
		reagents.add_reagent("sprinkles", 2)
...
/obj/item/reagent_containers/food/snacks/creamcheesebreadslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("protein", 3)
		reagents.add_reagent("nutriment", 1)
...
/obj/item/reagent_containers/food/snacks/watermelonslice/New()
	..()
	if(!(reagents.total_volume))
...
/obj/item/reagent_containers/food/snacks/applecakeslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 3)
...
/obj/item/reagent_containers/food/snacks/pumpkinpieslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 3)
...
/obj/item/reagent_containers/food/snacks/margheritaslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 5)
...
/obj/item/reagent_containers/food/snacks/meatpizzaslice/New()
	..()
	if(!(reagents.total_volume))
...
/obj/item/reagent_containers/food/snacks/mushroompizzaslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 5)
		reagents.add_reagent("protein", 1)
...
/obj/item/reagent_containers/food/snacks/vegetablepizzaslice/New()
	..()
	if(!(reagents.total_volume))
		reagents.add_reagent("nutriment", 4)
		reagents.add_reagent("protein", 1)
...
/obj/item/reagent_containers/food/snacks/liquidfood/New()
	..()
	reagents.add_reagent("nutriment", 20)
...
/obj/item/reagent_containers/food/snacks/skrellsnacks/New()
	..()
	reagents.add_reagent("nutriment", 10)
	bitesize = 3
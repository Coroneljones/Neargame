...
/obj/item/clothing/head/amulet/dogtag
	name = "Red-Dawn dogtag"
	desc = "Remembering is a cruelty."
	icon = 'icons/obj/clothing/amulets.dmi'
	icon_state = "dogtag"
	item_state = "dogtag"
	neck_use = TRUE
...
/obj/item/clothing/head/amulet/seaspotter
	name = "fisherman tooth"
	desc = "The seas speaks to you."
	icon = 'icons/obj/clothing/amulets.dmi'
	icon_state = "seaspotter"
	item_state = "seaspotter"
	neck_use = TRUE
	item_worth = 16
